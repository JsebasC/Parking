...
namespace Parking.API.Application.Validation.Filters
{
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {

        //Cuando ocurre un error no manejado en la API se ejecutará este Exception Filter
        //estandard definido aquí -> RFC 7807 - Problem Details for HTTP APIs (ietf.org).
        public override void OnException(ExceptionContext context)
        {
            switch (context.Exception)
            {
                ...
                case LogicException logicException:
                    HandleLogicException(context, logicException);
                    break;
        ...
        private void HandleLogicException(ExceptionContext context, LogicException logicException)
        {        
